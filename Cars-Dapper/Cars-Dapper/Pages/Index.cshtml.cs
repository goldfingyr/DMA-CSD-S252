...
namespace Cars_Dapper.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            if (string.IsNullOrEmpty(connectionString)) connectionString = "Data Source=localhost;Initial Catalog=Teknologi;User ID=sa;Password=!Password;Trust Server Certificate=True";
